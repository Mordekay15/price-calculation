"""
core/parser/tatasteel.py
========================
Parses the Tata Steel monthly price list PDF.

Layout (as of the current template):
  page 2 — quantity forecast
  page 3 — table 0: thin sheets, table 1: thick sheets,
           table 2: surcharges, table 3: special stocked item
"""
